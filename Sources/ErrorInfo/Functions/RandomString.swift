...
extension ErrorInfoFuncs {
  ...
  private static let alphaNumericAsciiSet: Set<UInt8> = mutate(value: Set<UInt8>()) {
  ...
  private static let allPrintableExcludingReservedAsciiSet: Set<UInt8> = mutate(value: Set<UInt8>()) {
